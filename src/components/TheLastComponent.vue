...
<template>
  ...
  >
    ...
    >
        ...
        <ul class="space-y-4 text-lg font-medium leading-relaxed">
          <li class="flex items-center gap-4">
            <svg class="w-7 h-7 text-green-400" fill="none" stroke="currentColor" stroke-width="2.5"
              ...
              <path
                d="M3 5a2 2 0 012-2h3l2 5-2 2a11 11 0 005 5l2-2 5 2v3a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
            </svg>
            <a href="tel:+255747100444" class="hover:text-green-300 transition">+255 747 100 444</a>
          </li>
          <li class="flex items-center gap-4">
            <svg class="w-7 h-7 text-green-400" fill="none" stroke="currentColor" stroke-width="2.5"
              viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round">
      ...
      <div class="w-full md:max-w-sm bg-white text-blue-900 rounded-xl shadow-lg p-4 md:p-5 space-y-4">
        ...
        >
          <div>
            ...
            <input
              ...
              name="name"
              required
              class="w-full px-3 py-2 border border-blue-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-blue-700"
            />
          </div>
          <div>
          ...
          <button
            type="submit"
            class="bg-blue-900 text-white px-5 py-2 rounded-md text-sm hover:bg-blue-800 transition"
          >
            Send Message
          </button>
        </form>
      ...
      <div class="flex-shrink-0">
        <img
          :src="Logo"
          alt="Open Sea Logo"
          class="h-44 md:h-64 object-contain drop-shadow-xl"
        />
      </div>
    </div>
  </section>
