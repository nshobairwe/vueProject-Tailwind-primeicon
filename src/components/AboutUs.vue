...
<template>
  <section
    class="w-full bg-gradient-to-r from-blue-50 via-blue-100 to-blue-50 py-16 mt-24 md:mt-32"
  >
    <div
      class="flex flex-col md:flex-row items-center justify-center gap-10 px-8 max-w-7xl mx-auto"
    >
