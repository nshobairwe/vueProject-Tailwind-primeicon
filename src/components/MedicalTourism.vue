...
<template>
  <section class="min-h-screen py-16 px-6 md:px-20 space-y-20 bg-gradient-to-b from-green-50 mt-32 to-white text-gray-900">
    ...
    >
      <h2 class="text-2xl mb-4">{{ $t('case_title') }}</h2>
    ...
    >
      <h2 class="text-3xl font-bold text-green-700 mb-5">{{ $t('affordable_title') }}</h2>
    ...
    >
      <h2 class="text-2xl text-green-700 font-bold mb-4">{{ $t('contact_title') }}</h2>
      <p class="mb-6 text-gray-700 font-medium">{{ $t('contact_desc') }}</p>
